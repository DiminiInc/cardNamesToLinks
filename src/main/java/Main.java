...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String[] wildSets = {"EXPERT1", "LEGACY", "NAXX", "GVG",
                ...
                "THE_SUNKEN_CITY", "THE_SUNKEN_CITY_MINI_SET", "REVENDRETH", "REVENDRETH_MINI_SET", "PATH_OF_ARTHAS", "RETURN_OF_THE_LICH_KING", "RETURN_OF_THE_LICH_KING_MINI_SET",
                "BATTLE_OF_THE_BANDS", "BATTLE_OF_THE_BANDS_MINI_SET", "WONDERS", "TITANS", "TITANS_MINI_SET", "WILD_WEST", "WILD_WEST_MINI_SET"
        };
